    ...
    <>
      <header className="sticky top-0 z-40 w-full bg-slate-950/95 backdrop-blur-md border-b border-slate-800/80 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            >
              <img
                ...
                alt="Logo VaiCar"
                className="w-9 h-9 rounded-lg object-cover border border-emerald-500/80 shadow-md group-hover:scale-105 transition-transform shrink-0"
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400 block -mt-1 font-medium">São Sebastião · SP</span>
              </div>
            </button>
          </div>
            ...
            {onOpenLegal && (
              <>
                ...
                <button
                  ...
                  className="hover:text-white transition-colors cursor-pointer py-1 text-slate-400"
                >
                  Termos
                </button>
              </>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            {currentRole === 'PASSENGER' && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-emerald-500/40 px-3 py-1.5 rounded-lg transition-all cursor-pointer text-left"
                ...
                {onLogout && (
                  <button
                    onClick={onLogout}
                    className="p-2 text-slate-400 hover:text-rose-400 bg-slate-900 hover:bg-slate-850 border border-slate-800 rounded-lg transition-all cursor-pointer"
                    title="Sair da Conta"
                  >
            ...
            {currentRole === 'DRIVER' && (
              <div className="flex items-center gap-2">
                {availableDrivers.length > 0 && onSelectDriverId && (
                  <div className="hidden sm:flex items-center gap-2 bg-slate-900 px-2.5 py-1.5 rounded-lg border border-slate-800 text-xs">
                    ...
                    <select
                      ...
                      className="bg-slate-950 text-white rounded-md px-2 py-0.5 border border-slate-700 text-xs outline-none focus:border-emerald-500 cursor-pointer"
                    >
                ...
                {onLogout && (
                  <button
                    onClick={onLogout}
                    className="flex items-center gap-1.5 text-xs text-slate-300 hover:text-white bg-slate-900 hover:bg-slate-850 border border-slate-800 px-2.5 py-1.5 rounded-lg transition-all cursor-pointer"
            ...
            {!currentRole && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-2 text-xs sm:text-sm font-semibold text-slate-200 hover:text-white bg-slate-900 hover:bg-slate-850 border border-slate-700 rounded-lg transition-all cursor-pointer whitespace-nowrap"
                >
                  Entrar
                </button>
                <button
                  onClick={() => setAuthModalOpen('REGISTER')}
                  className="px-4 py-2 text-xs sm:text-sm font-bold text-slate-950 bg-emerald-500 hover:bg-emerald-400 rounded-lg shadow-md shadow-emerald-500/10 hover:shadow-emerald-500/20 transition-all cursor-pointer whitespace-nowrap"
                >
                  Cadastrar
                </button>
              </div>
            ...
            <button
              ...
              className="lg:hidden p-2 text-slate-300 hover:text-white bg-slate-900 border border-slate-800 rounded-lg transition-colors cursor-pointer"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-slate-950 border-b border-slate-800 px-4 py-6 space-y-4 animate-fade-in shadow-2xl">
            <div className="grid grid-cols-2 gap-2 text-sm font-medium">
              <button
                onClick={() => scrollToSection('inicio')}
                className="p-3 bg-slate-900/90 rounded-lg text-left text-slate-200 hover:text-emerald-400 border border-slate-800"
              >
                Início
              </button>
              <button
              ...
              {onOpenLegal && (
                <>
                  ...
                  <button
                    ...
                    className="p-3 bg-slate-900/90 rounded-lg text-left text-slate-200 hover:text-emerald-400 border border-slate-800 col-span-2"
                  >
                    Termos de Uso
                  </button>
                </>
            ...
            <div className="pt-2 border-t border-slate-800/80 space-y-2">
              <button
                ...
                className="w-full py-3 bg-slate-900 text-white font-bold rounded-lg border border-slate-700 text-sm flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full py-3 bg-emerald-500 text-slate-950 font-black rounded-lg text-sm flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/10"
              >
      ...
      {authModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 max-w-md w-full space-y-6 shadow-2xl relative animate-scale-up">
            <button
              onClick={() => setAuthModalOpen(null)}
              className="absolute top-4 right-4 p-2 text-slate-400 hover:text-white bg-slate-950 rounded-lg border border-slate-800 cursor-pointer"
            ...
            <div className="space-y-2 text-center">
              <div className="inline-flex p-3 bg-emerald-500/10 text-emerald-400 rounded-xl mb-1">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full p-4 bg-slate-950 hover:bg-slate-850 border border-slate-800 hover:border-emerald-500/50 rounded-xl text-left flex items-center justify-between group cursor-pointer transition-all"
              >
